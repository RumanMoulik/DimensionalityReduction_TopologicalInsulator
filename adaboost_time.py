...
fig_maxv,ax_maxv = plt.subplots(2,3, figsize=(6.5,3.5), sharex=True)
...
for i in range(0,6):
    ...
    ax_maxv[row,col].axhline(y = raw_time1, color = 'red', linestyle = '--')        
    ax_maxv[row,col].plot(dim_x,time1, marker = '.',color="c")
...
fig_maxv.savefig("adaboost_times.pdf", format='pdf')
